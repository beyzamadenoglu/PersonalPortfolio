  ...
  render() {
    ...
    return (
      <div className="container-fluid">
       <svg className="medium-card-svg" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" id="blobSvg">
                ...
                <stop offset="100%" style={{ "stop-color": "rgb(238, 205, 163)" }}></stop>
                </linearGradient>
                </defs>
                </svg>
